...
Future<List<Articles>> fetchArticleBySource() async {
  final response = await http.get(
      'https://newsapi.org/v2/top-headlines?sources=daily-mail&apiKey=${API_KEY}');
...
class EntertainScreen extends StatefulWidget {
  ...
  EntertainScreen({Key key,  this.source}) : super(key: key);
  @override
  _EntertainScreenState createState() => _EntertainScreenState();
}
...
class _EntertainScreenState extends State<EntertainScreen> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text("Entertainment News",style: TextStyle(
            color: Colors.black
          ),),
          elevation: 0.0,
          centerTitle: true,
