...
Future<List<Articles>> fetchArticleBySource() async {
  final response = await http.get(
      'https://newsapi.org/v2/top-headlines?sources=techradar&apiKey=${API_KEY}');
...
class TechScreen extends StatefulWidget {
  ...
  TechScreen({Key key,  this.source}) : super(key: key);
  @override
...
class _TechScreenState extends State<TechScreen> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text("Technology News",style: TextStyle(
              color: Colors.black
          ),),
          elevation: 0.0,
